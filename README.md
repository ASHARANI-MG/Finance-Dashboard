...
This project showcases a fully interactive Finance Dashboard built in Power BI to analyze business performance across multiple dimensions such as product categories, regions, discounts, and yearly trends. The dashboard is designed to help businesses quickly understand sales patterns, profit behavior, and operational efficiency.
...
Shows how different business segments contribute to the overall profitability.

🔹 3. Net Sales by Country (Bar Chart)

Helps identify which countries drive the highest revenue.

🔹 4. Profit Ratio Over Time (Line & Column Chart)

Reveals patterns and fluctuations in profitability across months/years.

🔹 5. Product-Level Insights

Drill-down visuals allow deeper analysis into product categories and subcategories.
